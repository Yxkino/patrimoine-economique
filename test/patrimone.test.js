...
describe("Test about salary evaluation", () => {
  it("should return 0", () => {
    const salary = new Flux(Ilo, "salary", 1000, new Date("2024-3-3"), null, 0, 3);
    assert.equal(salary.getValeur(new Date("2024-3-3")), 0);
  });

  it("should return 10_000", () => {
    const salary = new Flux(Ilo, "salary", 2500, new Date("2024-3-3"), null, 0, 4);
    assert.equal(salary.getValeur(new Date("2024-5-3")), 5000);
  });

  it("should return 2_400_000", () => {
    const salary = new Flux(Ilo, "salary", 600_000, new Date("2024-3-3"), null, 0, 15);
...
describe("Test about spending evaluation", () => {
  it("should return a -100_000", () => {
    const spending = new Flux(Ilo, "spending", -100_000, new Date("2024-3-3"), null, 0, 1);
    assert.equal(spending.getValeur(new Date("2024-3-3")), 0);
  });

  it("should return -240_000", () => {
    const spending = new Flux(Ilo, "spending", -120_000, new Date("2024-3-3"), null, 0, 2);
...
describe("Test about possession increasing ration", () => {
  it("should return 90_000", () => {
    const computer = new Possession("me", "salary", 100_000, new Date("2024-3-3"), null, 10);
  ...
  it('should return 220_000', () => {
    const savingsAccount = new Argent("me", "salary", 200_000, new Date("2024-3-3"), null, -10, TYPE_ARGENT.Epargne);
